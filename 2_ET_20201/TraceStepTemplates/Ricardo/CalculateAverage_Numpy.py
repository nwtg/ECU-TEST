...
class CalculateAverage_Numpy(NumpyBasedTraceStep):
    """
    ...
    def GetSignals(cls):
        ...
        """
        return [
            SignalDefinition('Signal', 'IN', optional=False, description=''),
            SignalDefinition('Average', 'OUT', optional=False, description='')
            ]
    ...
    def GetParameters(cls):
        ...
        """
        return [
            ParameterDefinition('duration', 'IN', default=None, description='')
        ]
    ...
    def Check(self, parameters):
        ...
        if not isinstance(parameters['duration'], (int, float)):
            raise TypeError('Parameter duration must be a number!')
    ...
    def Process(self, parameters, report, timeAxis, ranges, signals):
        ...
        for triggerRange in ranges:
            maxStamp = triggerRange.GetStopTime()
            minStamp = triggerRange.GetStartTime()
            newStartStamp = minStamp
            if newStartStamp + duration <= maxStamp:
                Range(newStartStamp)
