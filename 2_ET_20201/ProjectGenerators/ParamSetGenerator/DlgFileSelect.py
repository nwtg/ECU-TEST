...
class DlgFileSelect(wx.Dialog):
    ...
    def __init__(self, parent, aParamGenerator):
        ...
        self.txtFileName = wx.TextCtrl(self, value=aParamGenerator.PFilename)
    ...
    def OnCmdOkButton(self, event):
        ...
        self.theParamGenerator.PFilename = self.txtFileName.GetValue()
    ...
    def OnCmdBrowseButton(self, event):
        ...
        fileDlg = wx.FileDialog(parent=self,
                                ...
                                wildcard='File|*.*',
                                defaultDir=self.theParamGenerator.api.GetSetting('parameterPath'),
                                defaultFile='')

        if fileDlg.ShowModal() == wx.ID_OK:
            basePath = self.theParamGenerator.api.GetSetting('workspacePath') # Toto
            self.txtFileName.SetValue(os.path.relpath(fileDlg.GetPath(), basePath)) # Toto
